...
//     version 1.14.0
//     from Assets/XR Default Input Action.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/XR Default Input Action.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @XRDefaultInputAction: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @XRDefaultInputAction()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""XR Default Input Action"",
    ""maps"": [
        {
            ""name"": ""XRI LeftHand"",
            ""id"": ""e31d0c93-257e-4a26-8334-a34a516aa957"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
                    ""id"": ""2f591fdf-67f9-4a88-a0dc-a9ae21131b2b"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""98466641-9078-402c-b5af-0a4b29a477aa"",
        ...
        {
            ""name"": ""XRI RightHand"",
            ""id"": ""170dc097-382b-45e0-bc2e-186bf64492ed"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
                    ""id"": ""f29cc94a-328b-4cc5-a432-05990041f0d7"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4f7db534-9698-4dc7-9fb6-c9beb357ae74"",
    ...
    ~@XRDefaultInputAction()
    {
        UnityEngine.Debug.Assert(!m_XRILeftHand.enabled, "This will cause a leak and performance issues, XRDefaultInputAction.XRILeftHand.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRIRightHand.enabled, "This will cause a leak and performance issues, XRDefaultInputAction.XRIRightHand.Disable() has not been called.");
    }
    ...
    {
        private @XRDefaultInputAction m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public XRILeftHandActions(@XRDefaultInputAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct XRIRightHandActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public XRIRightHandActions(@XRDefaultInputAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
